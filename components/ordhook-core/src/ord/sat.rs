...
//    pub(crate) const SUPPLY: u64 = 2099999997690000;
    pub(crate) const SUPPLY: u64 = 200000000000000000;
...
mod tests {
    ...
    fn name() {
        ...
        assert_eq!(Sat(200000000000000000).name(), "a");
        assert_eq!(Sat(200000000000000000 - 1).name(), "b");
        assert_eq!(Sat(200000000000000000 - 25).name(), "z");
        assert_eq!(Sat(200000000000000000 - 26).name(), "aa");
    }

    #[test]
    fn number() {
        assert_eq!(Sat(200000000000000000).n(), 200000000000000000);
    }
    ...
    fn third() {
        assert_eq!(Sat(0).third(), 0);
        assert_eq!(Sat(10000 * COIN_VALUE - 1).third(), 4999999999);
        assert_eq!(Sat(10000 * COIN_VALUE).third(), 0);
        assert_eq!(Sat(10000 * COIN_VALUE + 1).third(), 1);
    }
